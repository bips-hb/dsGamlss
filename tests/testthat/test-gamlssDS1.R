...
test_that("discctrl_gamlssDS1", {
  ...
  outputDS1 <- gamlssDS1(formula="gamlss1_red$e3_bw tilde_symbol pbleft_parenthesisgamlss1_red$e3_gac_Noneright_parenthesis", 
...
test_that("outputDS1_gamlssDS1", {
  load(testthat::test_path("data_files", "GAMLSS", "gamlss1.rda"))
  mod.gamlss <- base::suppressWarnings(gamlss::gamlss(formula=e3_bw ~ pb(e3_gac_None), sigma.formula=e3_bw ~ pb(e3_gac_None), 
