...
test_that("discctrl_gamlssDS2", {
  ...
  temp_mod.gamlss.ds <- base::suppressWarnings(gamlss::gamlss(formula=e3_bw ~ pb(e3_gac_None), sigma.formula=e3_bw ~ binary_disc, 
  ...
  outputDS2 <- gamlssDS2(parameter="mu", family="BCPEleft_parenthesisright_parenthesis", data="gamlss1_red", 
