# gamlssDS3 called by ds.gamlss

This is the third server-side aggregate function called by `ds.gamlss`.
...
- `matrix`:
  ...
  updated penalized weighted least squares estimator for the
...
penalized weighted least squares estimator for gamma. This function is
