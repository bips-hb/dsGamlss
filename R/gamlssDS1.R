...
#' using the using the \code{\link[gamlss]{gamlss.control}} function. This is a 
#' comma-separated string of 7 numeric values:
...
#' RS algorithm using the using the \code{\link[gamlss]{glim.control}} function. 
#' This is a comma-separated string of 4 numeric values:
...
gamlssDS1 <- function(formula = formula, sigma.formula = sigma.formula, nu.formula = nu.formula,
  ...
  #**************************************************************************
  return(list(
    mod.gamlss.ds = mod.gamlss.ds, G.dev = G.dev,
